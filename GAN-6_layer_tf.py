...
generator_optimizer = keras.optimizers.Adam(learning_rate=learning_rate, beta_1=0.5, beta_2=0.999)
discriminator_optimizer = keras.optimizers.Adam(learning_rate=learning_rate, beta_1=0.5, beta_2=0.999)

# Load and preprocess your dataset here
image_directory = "/Volumes/Elements/GitHub/cats_with_birds/For_Training/Augmented3"
image_size = (256, 256 )
batch_size = 16

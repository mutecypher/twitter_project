...
checkpoint_dir = '/Volumes/Elements/GitHub/cats_with_birds/For_Training/checkpoints'
...
def generate_and_save_images(model, epoch, test_input):
  ...
  plt.savefig('/Volumes/Elements/GitHub/cats_with_birds/For_Training/checkpoints_image/image_at_epoch_{:04d}.png'.format(epoch))
  ##plt.show()
  plt.close()                     

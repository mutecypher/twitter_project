...
# Step 5: Build and evaluate the SARIMA model
order = (1, 1, 1)  # ARIMA order
seasonal_order = (0, 1, 1, 24)  # Seasonal order with a period of 24 hours
model = SARIMAX(train['measurement'], order=order, seasonal_order=seasonal_order).fit()
